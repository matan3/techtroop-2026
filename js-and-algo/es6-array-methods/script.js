...
// Exercise 1
users1 = users.map(u => ({ name: u.name, city: u.address.city }));
console.log(JSON.stringify(users1, null, 2));

// Exercise 2
users2 = users.filter(u => u.address.zipcode.startsWith("5"));
console.log(JSON.stringify(users2, null, 2));

// Exercise 3
users3 = users.filter(u => u.address.zipcode.startsWith("5")).map(u => u.id);
console.log(JSON.stringify(users3, null, 3));

// Exercise 4
users4 = users.map(u => u.name).filter(u => u.startsWith("C"));
console.log(JSON.stringify(users4, null, 3));

// Exercise 5
users5 = users.every(u => u.address.city === "South Christy");
console.log(JSON.stringify(users5, null, 3));

// Exercise 6
users6 = users.find(u => u.address.suite === "Apt. 950");
console.log(users6.company.name);
...
console.log(inventory.reduce((total, item) => total + (item.price * item.quantity), 0));
...
console.log(studentScores.reduce((counts, score) => {
    let grading = gradingScale(score);
